# Agile81 — Piano di rilancio 90 giorni (agosto → novembre 2026)

> Questo file va messo nella cartella del progetto accanto a `Agile81_TODO.md`.
> Contesto per Claude Code: leggere questo file insieme a `Agile81_TODO.md` prima di ogni sessione di lavoro.
> Rinominato da "SafetyAI" ad "Agile81" il 28/08/2026 — vedi la nota rebrand in `CLAUDE.md`.
...
- Differenziazione: **distribuzione, non tecnologia**. Tutti i concorrenti (Levels, Blumatica, Sicurweb, Namirial, TeamSystem, Sikuro, Twind) vendono via "richiedi una demo". Agile81 si prova in 5 minuti senza registrazione: upload attestati → analisi AI → Excel. Il freemium È il canale di acquisizione.
- Prezzi di mercato osservati: 50–300 €/mese (Twind da 79 €/mese per RSPP esterni; Sikuro ~500 €/anno). Fascia target per Agile81: 30–80 €/mese.
...
4. **Deploy di produzione completo**: dominio definitivo, server Node su Railway (config già presente), CORS ristretto al dominio finale, test del flusso completo end-to-end. ✅ Backend Railway e frontend Vercel verificati funzionanti end-to-end il 28/08/2026 (dominio ancora safetyai-lluu.vercel.app, da migrare a agile81.it).
